 ...
 export const projectsData: ProjectDetailContent[] = [
    {
      ...
      image: getImagePath("/cards/portfolio-1.jpg"),
      mainImage: getImagePath("/pages/Advisor-promo-breaker.avif"),
      ...
      processImages: [
        getImagePath("/pages/body_language.png"),
        getImagePath("/pages/eye_movement.png")
      ]
    },
    {
      ...
      tags: ["UX Research", "User Testing", "Wireframing", "Prototyping"],
      image: getImagePath("/cards/portfolio-1.jpg"),
      mainImage: getImagePath("/pages/ArticleImage_2.avif"),
      ...
      processImages: [
        getImagePath("/pages/skills_1.jpg"),
        getImagePath("/pages/skills_2.jpg")
      ],
      resultImages: [
        getImagePath("/pages/skills_3.jpg"),
        getImagePath("/pages/skills_4.jpg")
      ]
    },
    {
      id: 'learning-pool',
      ...
      image: getImagePath("/cards/keymetrics1.png"),
      mainImage: getImagePath("/pages/keymetrics1.png"),
      ...
      processImages: [
        getImagePath("/pages/keymetrics2.png"),
        getImagePath("/pages/keymetrics3.png")
      ]
    }
 ];