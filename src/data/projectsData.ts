 ...
 export const projectsData: ProjectDetailContent[] = [
    {
      ...
      image: getImagePath("/portfolio-1.jpg"),
      mainImage: getImagePath("/Advisor-promo-breaker.avif"),
      ...
      processImages: [
        getImagePath("/body_language.png"),
        getImagePath("/eye_movement.png")
      ]
    },
    {
      ...
      tags: ["UX Research", "User Testing", "Wireframing", "Prototyping"],
      image: getImagePath("/portfolio-1.jpg"),
      mainImage: getImagePath("/ArticleImage_2.avif"),
      ...
      processImages: [
        getImagePath("/skills_1.jpg"),
        getImagePath("/skills_2.jpg")
      ],
      resultImages: [
        getImagePath("/skills_3.jpg"),
        getImagePath("/skills_4.jpg")
      ]
    },
    {
      id: 'learning-pool',
      ...
      image: getImagePath("/keymetrics1.png"),
      mainImage: getImagePath("/keymetrics1.png"),
      ...
      processImages: [
        getImagePath("/keymetrics2.png"),
        getImagePath("/keymetrics3.png")
      ]
    }
 ];